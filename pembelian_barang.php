...
if(!isset($_GET['no_pembelian']) || empty($_GET['no_pembelian'])){
    echo "<script>alert('No pembelian tidak ditemukan!');window.location='transaksi_pembelian.php';</script>";
    exit;
}
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if($b['gambar_produk']): ?>
                            <img src="../../uploads/<?php echo $b['gambar_produk']; ?>" width="60" height="45" style="object-fit:cover; border-radius:4px;">
                          <?php else: ?>
                            <span class="text-muted">-</span>
                          <?php endif; ?>
                        </td>
                        <td>
                          <a href="?no_pembelian=<?php echo urlencode($no_pembelian); ?>&action=pilih_barang&kd_barang=<?php echo $b['kd_barang']; ?>"
              ...
              <div class="card-body">
                ...
                <form method="POST">
                  <div class="form-group row mb-3">
                    <label class="col-sm-5 col-form-label font-weight-bold">Nomor Faktur Pembelian</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control bg-light" value="<?php echo $no_pembelian; ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-7">
                      ...
                      <a href="?no_pembelian=<?php echo urlencode($no_pembelian); ?>&action=pilih_barang"
                         class="btn btn-success btn-sm mt-1">Cari Barang</a>
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                  ...
                  <div class="form-group row mb-3">
                    <label class="col-sm-5 col-form-label font-weight-bold">Kode Jenis Barang</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group row mb-3">
                    <label class="col-sm-5 col-form-label font-weight-bold">Stok Saat ini</label>
                    <div class="col-sm-7">
                      <p class="mt-2 mb-0"><?php echo $barang_dipilih['stok'] ?? '-'; ?></p>
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                    <label class="col-sm-5 col-form-label font-weight-bold">Harga Barang</label>
                    <div class="col-sm-7">
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="?no_pembelian=<?php echo urlencode($no_pembelian); ?>&action=pilih_barang&hapus_item=<?php echo $d['no_item']; ?>"
