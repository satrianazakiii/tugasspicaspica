...
if(isset($_POST['filter'])){
    ...
    $where = "WHERE tb_pembelian.tanggal_pembelian BETWEEN '$tgl_dari' AND '$tgl_sampai'";
}

$data = mysqli_query($conn, "SELECT tb_pembelian.*, tb_supplier.nama_supplier
                              FROM tb_pembelian
                              LEFT JOIN tb_supplier ON tb_pembelian.id_supplier = tb_supplier.id_supplier
                              $where
                              ORDER BY tb_pembelian.tanggal_pembelian ASC");
    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse show" id="auth2">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link active" href="laporan_pembelian.php">Laporan Transaksi Pembelian</a></li>
      ...
      <div class="content-wrapper">
        ...
        <div class="row no-print">
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Filter Laporan Transaksi Pembelian</h4>
                <form method="POST" class="d-flex align-items-end gap-3">
                  ...
                  <div class="form-group mb-0">
                    ...
                    <a href="laporan_pembelian.php" class="btn btn-secondary">Reset</a>
                  </div>
                </form>
              </div>
            </div>
