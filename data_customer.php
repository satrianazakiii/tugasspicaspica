...
$data = mysqli_query($koneksi, "SELECT * FROM tb_customer ORDER BY id_customer ASC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <a href="tambah_customer.php" class="btn btn-success btn-sm">+ Tambah Customer</a>
                </div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="edit_customer.php?id_customer=<?php echo $row['id_customer']; ?>" class="btn btn-warning btn-sm">Edit</a>
                          <a href="hapus_customer.php?id_customer=<?php echo $row['id_customer']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus customer ini?')">Hapus</a>
                        </td>
                      </tr>
                      <?php endwhile; ?>
                    </tbody>
